...
import studentsystem.model.ScoreAnalyzeModel;
...
public class ScoreAnalyzeFrame extends JDialog{
	...
	public ScoreAnalyzeFrame(JDialog owner, String title, boolean modal,String major_Id,String major_Name,String grade,String classe){
		...
		for(int i=0;i<courses.size();i++){
			...
			highestScoreText.setBounds(221, 48+vgap, 40, 20);
			//设置最高成绩
			...
			lowest_ScoreText.setBounds(326, 48+vgap, 40, 20);
			//设置最低成绩
			...
			avg_ScoreText.setBounds(431, 48+vgap, 40, 20);
