...
public class StudentSystemMainFrame extends JFrame {
	...
	private JMenu help_File;	//帮助文档菜单
	...
	private JTextField help_Blog;	//帮助博客
	...
	public StudentSystemMainFrame(User user){
		...
		//	添加帮助文档
		help_File = new JMenu("帮助");
		menuBar.add(help_File);
		help_Blog = new JTextField("https://xiaoyi-s.github.io/");
		help_File.add(help_Blog);
